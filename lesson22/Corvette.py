#from lesson22.StarShips.CapitalShip import CapitalShip
#при попытке импортировать что либо из другого файла вылезает ошибка про несуществующий модуль
#уже много чем пытался исправлять, ничего не помогает
...
if __name__ == "__main__":
    ...
    c.damage(500)
    print(c.hp)
    c.set_max_speed('5000000 km per hour')
    print(c.show_max_speed())
    c.set_length('10000 meters')
    print(c.show_length())
    print(c.name)
